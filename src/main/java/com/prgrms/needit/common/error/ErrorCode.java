...
public enum ErrorCode {
	...
	NOT_FOUND_APPLY_COMMENT(404, "D006", "존재하지 않는 기부신청댓글입니다."),

	NOT_FOUND_CONTRACT(404, "R001", "해당 기부 예약을 찾을 수 없습니다."),
	NOT_SUPPORTED_STATUS(400, "R002", "적용할 수 없는 예약 상태입니다."),
	INVALID_BOARD_TYPE(400, "R003", "올바르지 않은 게시글 타입입니다."),
	...
	NOT_FOUND_DONATION_WISH(404, "W002", "존재하지 않는 기부희망글입니다."),
